...
public interface AnswerService {
    ...
    /* 가게 문의사항 답변 작성 */
    ResResultDto productAnswerWrite(UserInfo userInfo, ReqAnswerDto reqAnswerDto, Long c_id, Long qn_id);
    
    /* 가게 문의사항 답변 수정 */
    ResResultDto productAnswerEdit(UserInfo userInfo, ReqAnswerDto reqAnswerDto, Long c_id, Long qn_id, Long a_id);
    
    /* 가게 문의사항 답변 삭제 */
    ResResultDto productAnswerDelete(UserInfo userInfo, Long c_id, Long qn_id, Long a_id);
